  ...
  return (
    <header className="flex items-center justify-between px-4 py-3 bg-background border-b">
      ...
      <div className="flex flex-1 justify-end">
        {/* Log Out Button */}
        <Button className="inline-flex items-center gap-2 rounded-md px-4 py-2 font-medium shadow hover:bg-gray-200 hover:text-black active:ring active:ring-offset-2 active:ring-gray-400 transition-all duration-1000 ease-out">
          <LogOut />
